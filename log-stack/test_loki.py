...
from _lib import green, red, load_manifest, load_state, select_backend
...
def main():
    ...
    parser.add_argument("--loki-host", metavar="IP",
                        help="Tailscale IP of the log-stack server (skips auto-detect)")
    ...
    if args.loki_host:
        ...
        loki_host = entry.get("tailscale_ip")
        if not loki_host:
