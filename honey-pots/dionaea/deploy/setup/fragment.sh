...
su -s /bin/bash honey -c "cd ${DEPLOY_DIR} && ${HONEY_DC} build dionaea"
...
echo "    DOCKER_HOST=${HONEY_DOCKER_HOST} docker compose -f ${DEPLOY_DIR}/docker-compose.yml logs -f dionaea"
